...
// Function to copy variant-1 images to main images for all characters
function copyAllVariantsToMain() {
...
console.log('🚀 Copying all variant images to main images...');
copyAllVariantsToMain();
